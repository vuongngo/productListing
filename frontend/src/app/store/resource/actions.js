...
export const resourceCreateRequest = (resource, data, resolve, reject) => ({
...
export const RESOURCE_LIST_READ_META = 'RESOURCE_LIST_READ_META';
...
export const resourceListReadMeta = (resource, obj, request) => ({
  type: RESOURCE_LIST_READ_META,
  payload: obj,
  meta: {
    request,
    resource,
