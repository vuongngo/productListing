...
test('getMeta', () => {
  expect(selectors.getMeta()).toBe(selectors.initialResourceState.meta);
  expect(selectors.getMeta({})).toBe(selectors.initialResourceState.meta);
  expect(selectors.getMeta(undefined, 'resources')).toBe(selectors.initialResourceState.meta);
  expect(selectors.getMeta(altState, 'resources')).toBe(altState.resources.meta);
});
